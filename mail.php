...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	try {
		...
		if ($recaptcha == "3") {
			...
			$rcpSecret = "6LfAZbQUAAAAAKF2Iz_pPNjp6e_AXYhhsIrJAIQz";
		...
		$template = "Hi,<br><br>You have received a new message from your website.<br><br>{formdata}<br><br>---<br>Have a nice day.";
		...
		$from = ("1" == "1" ? $_POST["email"] : "no-reply@witsec.nl");
